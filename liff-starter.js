window.onload = function() {
    ...
    const defaultLiffId = "1653728986-qGdQykmO";   // change the default LIFF value if you are not using a node server
...
function registerButtonHandlers() {
    ...
    document.getElementById('openWindowButton').addEventListener('click', function() {
        liff.openWindow({
            url: 'https://subsfinal.herokuapp.com/',
            external: true
        });
    });
